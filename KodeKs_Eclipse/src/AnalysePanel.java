...
/**
 * Table of the moves each player made
 * 
...
public class AnalysePanel extends JPanel implements Serializable {
	...
	/**
	 * Constructor of an analyse panel. Here the players can see which moves they made during the game
	 * 
	 * @param size
	 *            - Dimension
	 * 
	...
	/**
	 * Method to update the analysis panel after each turn.
	 * 
	 * @param start
	 *            - Location
	 * @param end
	...
	/**
	 * Method to empty the AnalysePanel
	 * 
	 */
