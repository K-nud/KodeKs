...
/**
 * The mainframe of the GUI contains a menu bar, a tool bar, a panel on which the board is displayed, etc.
 * 
...
public class GUI extends JFrame implements ActionListener, MouseListener, Serializable {
	...
	/**
	 * Construct a GUI to play KodeKs. It gets its data by the Board_At_Start of KodeKsData. The mainframe of the GUI contains a menu bar, a tool bar, a panel
